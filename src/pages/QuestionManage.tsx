...
export default function QuestionManage() {
  ...
  return (
    <div className="w-full space-y-6">
          ...
          <div className="flex flex-wrap gap-2">
            ...
            <div className="flex items-center gap-2 border border-gray-300 rounded-lg px-3 py-2 dark:border-gray-700">
              ...
              <select
                ...
                className="text-sm bg透明 border-none outline-none text-gray-700 dark:text-gray-300"
              >
      ...
      <div className="rounded-xl border border-gray-200 bg白 shadow-sm dark:border-gray-800 dark:bg-gray-900 overflow-hidden">
        <div className="p-6">
          {loading ? (
